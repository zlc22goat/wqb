    ...
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label="答案" prop="answerOption">
        <el-checkbox-group v-model="checkboxGroup">
          <el-checkbox v-model="checkedA" label="0" @change="handleCheckedDatesChange(0)">A</el-checkbox>
          <el-checkbox v-model="checkedB" label="1" @change="handleCheckedDatesChange(1)">B</el-checkbox>
          <el-checkbox v-model="checkedC" label="2" @change="handleCheckedDatesChange(2)">C</el-checkbox>
          <el-checkbox v-model="checkedD" label="3" @change="handleCheckedDatesChange(3)">D</el-checkbox>
        </el-checkbox-group>
      </el-form-item>
